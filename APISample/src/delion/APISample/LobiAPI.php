<?php
namespace delion\APISample;//ネームスペースは各自修正

use delion\APISample\HttpAPI\Http;//ネームスペースは各自修正
use delion\APISample\HttpAPI\Header;//ネームスペースは各自修正
...
class LobiAPI{
	...
	public function TwitterLogin($mail, $password){
		...
		if(strpos($source, 'Twitterにログイン') !== false)
			return false;
